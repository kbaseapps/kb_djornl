...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_djornl'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_djornl.kb_djornlImpl import kb_djornl  # noqa @IgnorePep8
impl_kb_djornl = kb_djornl(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_djornl'
        ...
        self.rpc_service.add(impl_kb_djornl.run_rwr_loe,
                             name='kb_djornl.run_rwr_loe',
                             types=[dict])
        self.method_authentication['kb_djornl.run_rwr_loe'] = 'required'  # noqa
